...
export class InitSchema1770680615251 implements MigrationInterface {
    name = 'InitSchema1770680615251'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "body" character varying NOT NULL, "is_published" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL, "authorId" uuid NOT NULL, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
